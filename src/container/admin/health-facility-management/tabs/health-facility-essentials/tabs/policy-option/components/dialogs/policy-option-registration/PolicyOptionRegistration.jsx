...
function PolicyOptionRegistrationDialog(props) {
    ...
    <Dialog open={open} maxWidth="md" fullWidth>
      ...
      >
        ...
        >
          ...
          />
          <FormInput label="Number Of Option" />
        </Stack>
        <Stack
          direction="row"
          justifyContent="end"
        ...
        >
          <Button
            ...
            color="error"
            variant="outlined"
            onClick={() => toggleDialogState('policyOptionRegistration', false)}
          >
            Cancel
          </Button>
          <LoadingButton
            onClick={() => {
              toggleDialogState('policyOptionSummary', true);
            }}
            sx={{
              width: '15rem',
            }}
...
export default PolicyOptionRegistrationDialog;
