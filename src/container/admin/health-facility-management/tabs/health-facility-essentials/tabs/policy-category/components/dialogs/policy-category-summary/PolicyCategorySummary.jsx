...
function PolicyCategorySummaryDialog(props) {
  ...
  const renderOtherDetails = () => {
    return (
      <Stack direction="column" spacing="2rem">
        ...
        <Stack direction="row" spacing={1}>
          <Key>Added By:</Key>
          <Value>Catherine Tuka</Value>
        </Stack>
        <Stack direction="row" spacing={1}>
          <Key>Date Added:</Key>
          <Value>21-04-2022</Value>
        </Stack>
      </Stack>
    );
  };
        ...
        >
          ...
          <Stack direction="row" spacing={2} alignItems="center">
            <Button
              ...
              variant="outlined"
              color="error"
              onClick={() => toggleDialogState('policyCategorySummary', false)}
            >
              Cancel
            </Button>
            <Button
...
export default PolicyCategorySummaryDialog;
